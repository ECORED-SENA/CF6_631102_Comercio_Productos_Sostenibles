...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .row.justify-content-center.align-items-center
          .col-lg-6.mb-4.mb-lg-0
            ...
            ul
              ...
              li 
                i.fas.fa-angle-right(style="color: #F57C00")
                |  Presupuesto final para toda la campaña.
          .col-lg-5
            figure
              img(src='@/assets/curso/tema2/img3.svg', style="width: 350px").m-auto
        .row.justify-content-center.align-items-center
          .col-lg-6.mb-4.mb-lg-0
    ...
    .tarjeta.bg-color10.p-5(data-aos="fade-left")
      LineaTiempoC.color-acento-contenido(text-small)
        .row.justify-content-center(titulo="Objetivo")
          .col-lg-6.mb-4.mb-lg-0
            p #[b Objetivo]
            p.mb-0 Conocer el #[b objetivo] primordial de la campaña o del elemento de la comunicación. Acá se empieza a trazar la vía por donde irá la estrategia y se plantearán las primeras ideas de cómo se llevará a cabo.
          .col-lg-4
            figure
        ...
        .row.justify-content-center(titulo="Características")
          .col-lg-6.mb-4.mb-lg-0
            p #[b Características]
            p.mb-0 #[b Saber las características e ideales de la empresa], para no tener problemas al momento de plantear posibilidades y poder trabajar de la mano y pensando en el bien común.
          .col-lg-4
            figure
              img(src='@/assets/curso/tema2/img3.png')
        .row.justify-content-center(titulo="Necesidades específicas")
          .col-lg-6.mb-4.mb-lg-0
            p #[b Necesidades específicas]
            p.mb-0 Las #[b necesidades específicas] tienen que ver con esos elementos que el cliente tiene presentes, sean características o información que se debe tener siempre al momento de pensar en la elaboración de la estrategia o el proyecto.
          .col-lg-4
            figure
        ...
        .row.justify-content-center(titulo="Condicionantes")
          .col-lg-6.mb-4.mb-lg-0
            p #[b Condicionantes]
            p.mb-0 Las #[b condicionantes] son los temas o elementos que, como su nombre indica, condicionarán los elementos, ya sea por cuestiones presupuestales o simplemente decisiones del cliente.
          .col-lg-4
            figure
        ...
        .row.justify-content-center(titulo="Presupuesto")
          .col-lg-6.mb-4.mb-lg-0
            p #[b Presupuesto]
            p.mb-0 El #[b presupuesto] es indispensable para no soñar con proyectos inalcanzables, ayuda a tener los pies en la tierra, centrarse y administrar la energía para el aprovechamiento de todos los recursos.
          .col-lg-4
            figure
              img(src='@/assets/curso/tema2/img9.png')
        .row.justify-content-center(titulo="<i>Timing</i>")
          .col-lg-6.mb-4.mb-lg-0
            p #[b #[i Timing]]
            p.mb-0 El #[b #[i timing]] es otro elemento importante a tener en cuenta, ya que se debe ser precisos en los momentos de las entregas, de las presentaciones y reuniones con los clientes. Se trata de saber cuáles van a ser los plazos de ejecución, lo que permitirá ser más organizados.
          .col-lg-4
            figure
              img(src='@/assets/curso/tema2/img10.png')
        .row.justify-content-center(titulo="<i>Look and feel</i>")
          .col-lg-6.mb-4.mb-lg-0
            p #[b #[i Look and feel]]
            p.mb-0 El #[b #[i look and feel]] se puede entender como las características visuales y estéticas que se utilizarán al momento de la creación de los proyectos, al igual que algunas referencias a tener en cuenta.
          .col-lg-4
            figure
              img(src='@/assets/curso/tema2/img11.png')
        .row.justify-content-center(titulo="Especificaciones técnicas")
          .col-lg-6.mb-4.mb-lg-0
            p #[b Especificaciones técnicas]
            p.mb-0 Las #[b especificaciones técnicas] son las características específicas de cómo el cliente quiere algo; se determinan todas las necesarias para no tener inconvenientes al momento de la creación del proyecto.
          .col-lg-4
            figure
      ...
      .col-lg-7.mb-4.mb-lg-0
        ...
        .cajon.color-primario.p-4.mb-4
          .row.align-items-center
            ...
            .col
              p.mb-0 El #[b proceso creativo] se puede pensar en cómo, a través de la consecución de varios pensamientos, bien encaminados, se logran visualizar y conceptualizar ideas para crear finalmente cosas novedosas, de una manera que otras personas no han contemplado, visto, o simplemente han pasado por alto.
        p.mb-0 Todo proceso creativo varía de acuerdo con cada individuo, ya que sus conocimientos, su forma de pensar y sus asociaciones con los elementos de la vida generan en cada persona un proceso creativo diferente, con un concepto diferente.
      .col-lg-5
        figure
      ...
      .col-lg-7.mb-4.mb-lg-0
        ...
        .cajon.color-secundario.p-4
          .row.align-items-center
            ...
            .col
              p.mb-0 Pero, ¿qué sucede si se dan los denominados “bloqueos creativos”? 
              p.mb-0 Todos pasan por esas situaciones y lo primero que se debe entender es que los bloqueos son temporales y que, a su vez, existen diferentes bloqueos y que cada uno se debe atacar desde su posición.
      .col-lg-5
        figure
    ...
    .row.mb-5(data-aos="fade-right")
      ...
      .col-lg-7
        p Siempre pensar en ideas diferentes, tanto para la solución como para dudar en la forma de pensar, es vital y ayuda a comprender de otra forma soluciones que no se tienen contempladas; caminar es uno de los estimulantes vitales, ya que ayuda a la estimulación de la circulación y, a su vez, a la circulación de ideas, ya que lo expone con miles de estímulos que constantemente bombardean y renuevan de ideas; y si eso no ayuda, descansar también permite que desde el inconsciente se manifiesten otras posibilidades poco usuales, que no se harían en un estado tan consciente.
        p.mb-0 Es importante estar estimulando las ideas para no caer en los bloqueos mentales, por lo que otras estrategias serán necesarias para tener despierta la creatividad, como tomar notas en una agenda donde se llevan todas las ideas que pasan por la mente, hacer conexiones con elementos y conceptos que no tengan relación, y cuestionar a cada momento todas las fallas que pueden existir y cómo solucionarlas; esto generará ideas constantes y ayudará a estimular y a conectar todas las ideas que ayudarán en la construcción del proceso creativo.
    .row.mb-4
      .col-lg-5.bg-color3
        .row.align-items-center
          .col-auto.px-0
      ...
      .col-lg-7.mb-4.mb-lg-0
        ...
        .cajon.color-primario.p-4
          .row.align-items-start
            .col-auto
              figure.mb-4.mb-lg-0
                img(src='@/assets/curso/tema2/img21.svg').m-auto
            .col
              p.mb-0 #[b La psicología de la imagen] es útil en el diseño, ya que el diseñador tiene que #[b transmitir de manera directa y eficaz] por medio de la imagen, un concepto de manera inmediata y eficaz. Para esto, debe tener muy presente el manejo de la percepción, el espacio y el tiempo en que se recibe este mensaje, todo esto para unir los conceptos y estudiar de mejor manera al usuario que va a recibir el mensaje, utilizando los sentidos y las sensaciones, para hacerla memorable.
      .col-lg-5
        figure
